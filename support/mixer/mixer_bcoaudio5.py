...
class BCoAudio5Control(BCoAudio5ControlUI):
    ...
    def init(self):
            ...
            self.VolumeControls={
                'in_line12'  :   ['/Mixer/Volume_1', self.sldInput12],
                'in_line34'  :   ['/Mixer/Volume_2', self.sldInput34],
                'in_spdif'   :   ['/Mixer/Volume_3', self.sldInputSPDIF],
                'out_line12' :   ['/Mixer/Volume_6', self.sldOutput12],
                'out_line34' :   ['/Mixer/Volume_7', self.sldOutput34],
                'cross_a'    :   ['/Mixer/Volume_4', self.sldCrossA],
                'cross_b'    :   ['/Mixer/Volume_5', self.sldCrossB],
                }
