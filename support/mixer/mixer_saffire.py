...
class SaffireMixerStereo(SaffireMixerStereoUI, SaffireMixerBase):
    ...
    def init(self):
        ...
        self.VolumeControls={
                self.sldPC910Out910: ['/Mixer/MatrixMixer', 0, 0],
                self.sldPC910Out12: ['/Mixer/MatrixMixer', 0, 1],
                self.sldPC910Out34: ['/Mixer/MatrixMixer', 0, 2],
                self.sldPC910Out56: ['/Mixer/MatrixMixer', 0, 3],
                self.sldPC910Out78: ['/Mixer/MatrixMixer', 0, 4],
                self.sldPC12Out910: ['/Mixer/MatrixMixer', 1, 0],
                self.sldPC12Out12: ['/Mixer/MatrixMixer', 1, 1],
                self.sldPC12Out34: ['/Mixer/MatrixMixer', 1, 2],
                self.sldPC12Out56: ['/Mixer/MatrixMixer', 1, 3],
                self.sldPC12Out78: ['/Mixer/MatrixMixer', 1, 4],
                self.sldPC34Out910: ['/Mixer/MatrixMixer', 2, 0],
                self.sldPC34Out12: ['/Mixer/MatrixMixer', 2, 1],
                self.sldPC34Out34: ['/Mixer/MatrixMixer', 2, 2],
                self.sldPC34Out56: ['/Mixer/MatrixMixer', 2, 3],
                self.sldPC34Out78: ['/Mixer/MatrixMixer', 2, 4],
                self.sldPC56Out910: ['/Mixer/MatrixMixer', 3, 0],
                self.sldPC56Out12: ['/Mixer/MatrixMixer', 3, 1],
                self.sldPC56Out34: ['/Mixer/MatrixMixer', 3, 2],
                self.sldPC56Out56: ['/Mixer/MatrixMixer', 3, 3],
                self.sldPC56Out78: ['/Mixer/MatrixMixer', 3, 4],
                self.sldPC78Out910: ['/Mixer/MatrixMixer', 4, 0],
                self.sldPC78Out12: ['/Mixer/MatrixMixer', 4, 1],
                self.sldPC78Out34: ['/Mixer/MatrixMixer', 4, 2],
                self.sldPC78Out56: ['/Mixer/MatrixMixer', 4, 3],
                self.sldPC78Out78: ['/Mixer/MatrixMixer', 4, 4],

                self.sldIN12Out910: ['/Mixer/MatrixMixer', 5, 0],
                self.sldIN12Out12: ['/Mixer/MatrixMixer', 5, 1],
                self.sldIN12Out34: ['/Mixer/MatrixMixer', 5, 2],
                self.sldIN12Out56: ['/Mixer/MatrixMixer', 5, 3],
                self.sldIN12Out78: ['/Mixer/MatrixMixer', 5, 4],
                self.sldIN34Out910: ['/Mixer/MatrixMixer', 6, 0],
                self.sldIN34Out12: ['/Mixer/MatrixMixer', 6, 1],
                self.sldIN34Out34: ['/Mixer/MatrixMixer', 6, 2],
                self.sldIN34Out56: ['/Mixer/MatrixMixer', 6, 3],
                self.sldIN34Out78: ['/Mixer/MatrixMixer', 6, 4],

                self.sldFXOut910: ['/Mixer/MatrixMixer', 7, 0],
                self.sldFXOut12: ['/Mixer/MatrixMixer', 7, 1],
                self.sldFXOut34: ['/Mixer/MatrixMixer', 7, 2],
                self.sldFXOut56: ['/Mixer/MatrixMixer', 7, 3],
                self.sldFXOut78: ['/Mixer/MatrixMixer', 7, 4],
                }
