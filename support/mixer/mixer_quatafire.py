...
class QuataFireMixer(QuataFireMixerUI):
    ...
    def init(self):
            ...
            self.VolumeControls={
                    self.sldCh1: ['/Mixer/Volume_1', 1],
                    self.sldCh2: ['/Mixer/Volume_1', 2],
                    self.sldCh34: ['/Mixer/Volume_2', 0],
                    self.sldCh56: ['/Mixer/Volume_3', 0],
                    self.sldDawAll: ['/Mixer/Volume_4', 0],
                    self.sldDawCH1: ['/Mixer/Volume_4', 1],
                    self.sldDawCH2: ['/Mixer/Volume_4', 2],
                    self.sldDawCH3: ['/Mixer/Volume_4', 3],
                    self.sldDawCH4: ['/Mixer/Volume_4', 4],
                    self.sldDawCH5: ['/Mixer/Volume_4', 5],
                    self.sldDawCH6: ['/Mixer/Volume_4', 6],
                    self.sldDawCH7: ['/Mixer/Volume_4', 7],
                    self.sldDawCH8: ['/Mixer/Volume_4', 8],
                    }
            self.PanControls={
                    #self.dialCh1: ['/Mixer/Volume_1'],
                    #self.dialCh2: ['/Mixer/Volume_1'],
                    self.dialCh34: ['/Mixer/Volume_2'],
                    self.dialCh56: ['/Mixer/Volume_3'],
                    }
