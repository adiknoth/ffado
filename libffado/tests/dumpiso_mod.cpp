...
void write_header()
{
        static char header[32] = "1394 isodump v3";
        int i;
        ...
        unsigned int dropped)
{
        ...
        raw1394_read_cycle_timer(global_handle, &cycle_timer, &local_time);
        ...
        write(file, &cycle_timer, sizeof(cycle_timer));
        write(file, &timestamp, sizeof(timestamp));
