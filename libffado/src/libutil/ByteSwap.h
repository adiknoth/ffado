...
static inline void
byteSwapBlock(uint32_t *data, unsigned int nb_elements)
{
    unsigned int i=0;
    for(; i<nb_elements; i++) {
...
static inline void
byteSwapToBus(uint32_t *data, unsigned int nb_elements)
{
    return;
}

static inline void
byteSwapFromBus(uint32_t *data, unsigned int nb_elements)
{
    return;
}
