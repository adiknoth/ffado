...
public:
     ...
     * @pre @c i smaller than getStreamCount()
     * @return a stream_settings struct if successful, NULL otherwise
     */
    virtual struct stream_settings *getSettingsForStream(unsigned int i) = 0;
