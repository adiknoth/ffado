...
public:
    ...
    */
    ...
    /**
     * @brief register an AddressRangeMapping
     *
     * @param start          identifies addressrange
     * @param length         identifies addressrange length
     ...
     * @param functor the function to call when this range is written to
     *
     * @return true on success or false on failure
     **/

    bool registerARMrange(nodeaddr_t start,
     ...
     */
    bool unregisterARMrange( nodeaddr_t start );
...
private:
    ...
    typedef std::vector< arm_mapping_t* > arm_mapping_vec_t;
    arm_mapping_vec_t m_arm_mappings;
